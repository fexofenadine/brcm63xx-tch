...
enum opt_code
{
  ...
  OPT_fhonour_copts = 641,                   /* -fhonour-copts */
  ...
  OPT_mbranch_cost_ = 1047,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1048,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1049,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1050,                /* -mcode-readable= */
  OPT_mdebug = 1051,                         /* -mdebug */
  OPT_mdebugd = 1052,                        /* -mdebugd */
  OPT_mdivide_breaks = 1053,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1054,                  /* -mdivide-traps */
  OPT_mdmx = 1055,                           /* -mdmx */
  OPT_mdouble_float = 1056,                  /* -mdouble-float */
  OPT_mdsp = 1057,                           /* -mdsp */
  OPT_mdspr2 = 1058,                         /* -mdspr2 */
  OPT_meb = 1059,                            /* -meb */
  OPT_mel = 1060,                            /* -mel */
  OPT_membedded_data = 1061,                 /* -membedded-data */
  OPT_mexplicit_relocs = 1062,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1063,                  /* -mextern-sdata */
  OPT_mfix_24k = 1064,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1065,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1066,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1067,                     /* -mfix-r4400 */
  OPT_mfix_sb1 = 1068,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1069,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1070,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1071,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1072,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1073,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1074,                 /* -mfp-exceptions */
  OPT_mfp32 = 1075,                          /* -mfp32 */
  OPT_mfp64 = 1076,                          /* -mfp64 */
  OPT_mfused_madd = 1077,                    /* -mfused-madd */
  OPT_mglibc = 1078,                         /* -mglibc */
  OPT_mgp32 = 1079,                          /* -mgp32 */
  OPT_mgp64 = 1080,                          /* -mgp64 */
  OPT_mgpopt = 1081,                         /* -mgpopt */
  OPT_mhard_float = 1082,                    /* -mhard-float */
  OPT_minterlink_mips16 = 1083,              /* -minterlink-mips16 */
  OPT_mips = 1084,                           /* -mips */
  OPT_mips16 = 1085,                         /* -mips16 */
  OPT_mips3d = 1086,                         /* -mips3d */
  OPT_mllsc = 1087,                          /* -mllsc */
  OPT_mlocal_sdata = 1088,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1089,                    /* -mlong-calls */
  OPT_mlong32 = 1090,                        /* -mlong32 */
  OPT_mlong64 = 1091,                        /* -mlong64 */
  OPT_mmad = 1092,                           /* -mmad */
  OPT_mmcount_ra_address = 1093,             /* -mmcount-ra-address */
  OPT_mmcu = 1094,                           /* -mmcu */
  OPT_mmemcpy = 1095,                        /* -mmemcpy */
  OPT_mmt = 1096,                            /* -mmt */
  OPT_mmusl = 1097,                          /* -mmusl */
  OPT_mno_float = 1098,                      /* -mno-float */
  OPT_mno_flush_func = 1099,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1100,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1101,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1102,                     /* -mno-mips3d */
  OPT_mpaired_single = 1103,                 /* -mpaired-single */
  OPT_mplt = 1104,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1105,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1106,               /* -mrelax-pic-calls */
  OPT_mshared = 1107,                        /* -mshared */
  OPT_msingle_float = 1108,                  /* -msingle-float */
  OPT_msmartmips = 1109,                     /* -msmartmips */
  OPT_msoft_float = 1110,                    /* -msoft-float */
  OPT_msplit_addresses = 1111,               /* -msplit-addresses */
  OPT_msym32 = 1112,                         /* -msym32 */
  OPT_msynci = 1113,                         /* -msynci */
  OPT_mtune_ = 1114,                         /* -mtune= */
  OPT_muclibc = 1115,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1116,        /* -muninit-const-in-rodata */
  OPT_mvr4130_align = 1117,                  /* -mvr4130-align */
  OPT_mxgot = 1118,                          /* -mxgot */
  OPT_n = 1119,                              /* -n */
  OPT_no_canonical_prefixes = 1120,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1121,              /* -no-integrated-cpp */
  OPT_noasmopt = 1122,                       /* -noasmopt */
  ...
  OPT_static_libstdc__ = 1169,               /* -static-libstdc++ */
  OPT_static_libtsan = 1170,                 /* -static-libtsan */
